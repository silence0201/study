    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <struts:form action="workPlanAddAction" onsubmit="return addWork();" method="get">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="wTitle" name="work_title" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>人数：</th>
                            <td>
                                <input class="common-text required" id="wNumber" name="work_person_num" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>工资：</th>
                            <td>
                                <input class="common-text required" id="wSalary" name="work_salary" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>最低工时：</th>
                            <td>
                                <input class="common-text required" id="wHour" name="work_hour" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>开始时间：</th>
                            <td>
                                <input class="common-text required" id="wStartTime" name="start_time" size="50" value="" type="time">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>结束时间：</th>
                            <td>
                                <input class="common-text required" id="wEndTime" name="end_time" size="50" value="" type="time">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
